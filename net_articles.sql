...
--
ALTER TABLE `achete`
 ADD PRIMARY KEY (`id_client`,`id_article`), ADD KEY `fk_achete_article` (`id_article`);

--
-- Index pour la table `article`
--
ALTER TABLE `article`
 ADD PRIMARY KEY (`id_article`), ADD KEY `fk_article_domaine` (`id_domaine`);

--
-- Index pour la table `auteur`
--
ALTER TABLE `auteur`
 ADD PRIMARY KEY (`id_auteur`), ADD UNIQUE KEY `un_auteur_login` (`login_auteur`);
...
--
ALTER TABLE `client`
 ADD PRIMARY KEY (`id_client`), ADD UNIQUE KEY `un_client_login` (`login_client`), ADD KEY `fk_client_categorie` (`id_categorie`);
...
--
ALTER TABLE `droits`
 ADD PRIMARY KEY (`id_auteur`,`date_trimestre`);

--
-- Index pour la table `redige`
--
ALTER TABLE `redige`
 ADD PRIMARY KEY (`id_article`,`id_auteur`), ADD KEY `fk_redige_auteur` (`id_auteur`);
